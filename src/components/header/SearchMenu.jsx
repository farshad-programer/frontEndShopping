    ...
    >
      <div className="flex items-center justify-between w-full">
        ...
        <div className="relative flex items-center ">
          ...
          <input
            ...
            autoFocus={true}
            type="text"
            className="w-full  border-blue-700 rounded-full text-gray-600 text-md bg-gray-200 pl-9"
      ...
      <div className="text-lg flex justify-between hover:bg-gray-200 transition-colors rounded-lg text-gray-700 items-center p-2">
        <span className="flex items-center justify-start ">
          <img src="" alt="" className="w-8 h-8 rounded-full mr-2 bg-gray-300 object-cover" />
          <span>sadra</span>
        </span>
